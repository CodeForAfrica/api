...
from check_api_queries import create_mutation_query, delete_mutation_query
...
def fetch_from_pesacheck():
    ...
    rss_api_key = os.getenv("PESACHECK_RSS2JSON_API_KEY")
...
def post_to_check(query):
    try:
        headers = {"Content-Type": "application/json",
                   "X-Check-Token": os.getenv("PESACHECK_TOKEN"), "X-Check-Team": os.getenv("PESACHECK_CHECK_WORKSPACE_SLUG")}
